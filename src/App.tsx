...
export default function App() {
  ...
  return (
    <>
      <div className='flex h-screen w-screen items-center gap-20 px-16 py-8 text-gray-100'>
        <div className='flex-1'>
          <p
            className='text-3xl font-black uppercase tracking-[1.2px]'
            style={{
          ...
          <p className='mt-2 max-w-lg cursor-text text-justify text-lg font-light text-sky-400'>
      ...
      <div className='fixed left-16 top-8 flex h-14 items-center gap-2'>
        <p
      ...
      <div
        className='fixed bottom-16 left-16 font-thin text-gray-200'
        style={{
      ...
      <div className='fixed bottom-32 right-16 flex h-60 flex-col items-center justify-center rounded-full text-white'>
